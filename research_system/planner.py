...
class OpenAICompatiblePlanner:
    ...
    def default_prompt(context: dict[str, Any]) -> str:
        ...
        return "\n".join([
            ...
            '{"kind":"symbolic_model_plan","representation":"infinite","model_name":"model","imports":["Mathlib.Tactic"],"carrier":"ℕ","definitions":["let helper := ...","let op (x y : Nat) := ..."],"operation":"op","setup":["have helper_fact : ... := by\\n  ..."],"hypothesis_proof":"intro x y z\\n...","counterexample_proof":"intro goal_holds\\nhave h := goal_holds ...\\n..."}',
            '{"kind":"symbolic_model_patch","set":{"hypothesis_proof":"<complete repaired tactic body>"}}',
